'use client';
/**
 * ReactBits <SplashCursor> (reactbits.dev/r/SplashCursor-TS-CSS), the WebGL
 * fluid simulation, tuned here to read as incense: a single warm gold, low
 * force, quick dissipation, so the pointer leaves a thread of smoke over the
 * painting rather than a rainbow. Fine pointers only; off under reduced
 * motion; runs once per mount (the original never tears down).
 */
