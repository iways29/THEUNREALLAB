  ...
  return (
    <section id="products" style={{ padding: "140px 48px", maxWidth: 1280, margin: "0 auto" }}>
      ...
      <div className="reveal" style={{
        ...
        {/* Mumba.ai */}
        <ProductCard style={{ gridColumn: "1 / -1" }}>
          <div className="card-body">
            <div className="mumba-inner">
              <div>
                <div style={{
                ...
                <div style={{ fontSize: "clamp(24px, 5vw, 42px)", fontWeight: 800, letterSpacing: "-0.02em", marginBottom: 16, lineHeight: 1 }}>
                  Mumba.ai
                </div>
                <p style={{ fontSize: "clamp(13px, 2vw, 15px)", color: "#666", lineHeight: 1.6, marginBottom: 40, maxWidth: 340 }}>
                ...
                <a href="https://mumba.ai" target="_blank" rel="noopener noreferrer"
                  style={{ display: "inline-flex", alignItems: "center", gap: 8, fontSize: 13, fontWeight: 600, letterSpacing: "0.06em", textTransform: "uppercase", color: "var(--text)", textDecoration: "none", transition: "gap 0.2s, color 0.2s" }}
                  onMouseEnter={e => { e.currentTarget.style.gap = "14px"; e.currentTarget.style.color = "var(--accent)"; }}
                  onMouseLeave={e => { e.currentTarget.style.gap = "8px"; e.currentTarget.style.color = "var(--text)"; }}
                >
                  Launch App
              ...
              <div>
                ...
                <p style={{ marginTop: 28, fontSize: 14, color: "#555", lineHeight: 1.7 }}>
                  Conversations aren&apos;t linear — so why should your AI be? Mumba reimagines the chat interface as a living tree where ideas branch, connect, and never get lost.
                </p>
              </div>
            </div>
          ...
          <div className="card-body">
            <div className="ashvaa-inner">
              <div>
                ...
                <div style={{ fontSize: "clamp(24px, 5vw, 42px)", fontWeight: 800, letterSpacing: "-0.02em", marginBottom: 14, lineHeight: 1 }}>
                  ASHVAA
                </div>
                <p style={{ fontSize: "clamp(13px, 2vw, 15px)", color: "#666", lineHeight: 1.65, marginBottom: 40, maxWidth: 420 }}>
              ...
              <div className="ashvaa-video" style={{ borderRadius: 10, overflow: "hidden", border: "1px solid var(--border-bright)", aspectRatio: "504 / 399", position: "relative" }}>
                <iframe
                  src="https://www.linkedin.com/embed/feed/update/urn:li:ugcPost:7469969628975427584?compact=1"
                  frameBorder="0" allowFullScreen title="ASHVAA demo"
        ...
        {/* Teaser */}
        <ProductCard style={{ gridColumn: "1 / -1", minHeight: 280 }}>
          <div className="card-body">
            <div className="teaser-inner">
              <div style={{ minWidth: 0 }}>
                ...
                <div style={{ fontSize: "clamp(24px, 5vw, 42px)", fontWeight: 800, letterSpacing: "-0.02em", lineHeight: 1, marginBottom: 16, color: "transparent", WebkitTextStroke: "1px rgba(255,255,255,0.12)" }}>
                  Something<br />Unreal
                </div>
                <p style={{ fontSize: 14, color: "#333", lineHeight: 1.65, maxWidth: 340 }}>
                  The next thing we&apos;re building hasn&apos;t been named yet. It&apos;ll ship when it&apos;s ready — and not a day before.
                </p>
              </div>
              <div className="teaser-redacted" style={{ display: "flex", flexDirection: "column", gap: 14, opacity: 0.35, flexShrink: 0 }}>
                {["████████████ ██████", "███████ ████ ██████████", "██████████████", "█████ ███████ ████"].map((line, i) => (
                  <div key={i} style={{ fontFamily: "'DM Mono', monospace", fontSize: 12, color: "var(--muted)", letterSpacing: "0.05em", filter: "blur(2px)" }}>{line}</div>
                ))}
                <div style={{ marginTop: 8, fontFamily: "'DM Mono', monospace", fontSize: 10, letterSpacing: "0.2em", textTransform: "uppercase", color: "#2a2a2a" }}>
